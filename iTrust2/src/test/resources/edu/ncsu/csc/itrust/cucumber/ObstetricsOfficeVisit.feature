...
Examples:
	| date			| time 		| patient 		| type 					  | hospital 			| weeksPregnant | fetalHeartRate	| fundalHeight	| isTwins 	| isLowLyingPlacenta 	| notes 	                                                     |
...
Examples:
	| date			| time 		| patient 		| type 					| hospital 			| weeksPregnant	    | fetalHeartRate	| fundalHeight	| isTwins	| isLowLyingPlacenta 	|  height  |  weight  |  systolic  |  diastolic  |  HDL    |  LDL  |  tri  | patientSmoking  | householdSmokingStatus  |  notes 									                |
